...
const Footer = () => {
  return (
    ...
    <Box flex="1" color={"gray"} textAlign="center">
        <Text fontSize="sm" >&copy; 2024 <Text as={"span"} display={"inline"} _hover={{ color: "red" }}>REDUKTOR.</Text> All rights reserved.</Text>
      </Box>
      <Box flex="1" color={"gray"} textAlign="center">
        <Flex justify="center">
          <Link href="#" mx="2" _hover={{ color: "red" }} fontSize="sm">
            Privacy Policy
          </Link>
          <Text mx="2">•</Text>
          <Link href="#" mx="2" _hover={{ color: "red" }} fontSize="sm">
